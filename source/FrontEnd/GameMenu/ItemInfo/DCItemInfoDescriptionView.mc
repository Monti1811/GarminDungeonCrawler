...
class DCItemInfoDescriptionView extends WatchUi.View {
	...
	function onUpdate(dc) {
		...
		var formatted_name = Graphics.fitTextToArea(_item.getName(), Graphics.FONT_MEDIUM, area_width, area_height, true);
		dc.drawText(text_x, name_y, Graphics.FONT_MEDIUM, formatted_name, Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
		var formatted_text = Graphics.fitTextToArea(_item.getDescription(), Graphics.FONT_XTINY, area_width, area_height, true);
